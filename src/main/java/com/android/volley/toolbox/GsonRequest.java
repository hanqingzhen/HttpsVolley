...
public class GsonRequest<T> extends Request<T> {
	 ...
	 */
	public GsonRequest(int method, String url, Class<T> clazz,
			Response.Listener<T> listener, Response.ErrorListener errorListener,boolean needCache) {
		this(method, url, null, null, listener, errorListener,needCache);
	}
	...
	public GsonRequest(int method, String url, Class<T> clazz,
			...
			Response.ErrorListener errorListener,boolean needCache) {
		this(method, url, clazz, null, params, listener, errorListener,needCache);
	...
	public GsonRequest(String url, Class<T> clazz,
			Response.Listener<T> listener, Response.ErrorListener errorListener,boolean needCache) {
		this(Method.GET, url, clazz, null, null, listener, errorListener,needCache);
	}
	...
	protected Response<T> parseNetworkResponse(NetworkResponse response) {
		try {
			...
			Log.d("----JSON---", json);
			if (needCache) {
				if (!json.equals(DataCache.getDataCache().queryCache(url))) {
